...
-- ==========================================================
insert into tbl_report (reporter_id, target_type, target_id, reason, detail, status, resolved_at, created_datetime)
values
    -- PENDING 신고 (10건)
    (100, 'WORK',   104, 'COPYRIGHT',    '해당 작품이 타인의 원작을 무단 복제한 것으로 보입니다.',                       'PENDING',   null,                    '2025-09-05 10:00:00'),
    (101, 'MEMBER', 107, 'HARASSMENT',   '해당 회원이 지속적으로 악성 댓글을 작성하고 있습니다.',                        'PENDING',   null,                    '2025-09-10 11:00:00'),
    (103, 'WORK',   112, 'SENSITIVE',    '미성년자가 보기에 부적절한 성적 이미지가 포함되어 있습니다.',                  'PENDING',   null,                    '2025-09-15 14:00:00'),
    (105, 'MEMBER', 118, 'IMPERSONATION','유명 작가의 작품을 자신의 것으로 속여 판매하고 있습니다.',                     'PENDING',   null,                    '2025-10-01 09:00:00'),
    (106, 'WORK',   120, 'COPYRIGHT',    '이 작품은 해외 유명 작가의 작품을 허가 없이 복제한 것입니다.',                 'PENDING',   null,                    '2025-10-05 13:00:00'),
    (108, 'COMMENT', 1,  'HARASSMENT',   '해당 댓글에 심한 욕설과 비하 발언이 포함되어 있습니다.',                      'PENDING',   null,                    '2025-10-10 16:00:00'),
    (110, 'WORK',   126, 'SENSITIVE',    '작품에 폭력적인 장면이 무분별하게 표현되어 있습니다.',                         'PENDING',   null,                    '2025-10-15 08:00:00'),
    (113, 'MEMBER', 119, 'HARASSMENT',   '반복적인 스팸성 메시지와 부적절한 컨텐츠를 지속 게시하고 있습니다.',           'PENDING',   null,                    '2025-11-01 12:00:00'),
    (115, 'WORK',   130, 'COPYRIGHT',    '상업적 목적으로 타인의 작품을 무단 도용한 정황이 있습니다.',                   'PENDING',   null,                    '2025-11-05 10:30:00'),
    (116, 'MEMBER', 107, 'IMPERSONATION','타인의 닉네임과 프로필을 도용하여 사기 행위를 하고 있습니다.',                 'PENDING',   null,                    '2025-11-10 15:00:00'),
    -- REVIEWING 신고 (8건)
    (117, 'WORK',   100, 'COPYRIGHT',    '유사한 작품이 타 사이트에서 다른 작가 명의로 게시된 것을 확인했습니다.',       'REVIEWING', null,                    '2025-07-01 09:00:00'),
    (120, 'MEMBER', 104, 'HARASSMENT',   '구매자에게 환불 거부 후 지속적인 위협 메시지를 발송하고 있습니다.',            'REVIEWING', null,                    '2025-07-05 14:00:00'),
    (100, 'WORK',   108, 'SENSITIVE',    '작품 설명에 혐오 발언과 차별적 표현이 다수 포함되어 있습니다.',                'REVIEWING', null,                    '2025-07-10 11:00:00'),
    (101, 'COMMENT', 3,  'HARASSMENT',   '타 작가를 겨냥한 인신공격성 댓글이 지속적으로 게시되고 있습니다.',             'REVIEWING', null,                    '2025-07-15 16:00:00'),
    (103, 'WORK',   114, 'COPYRIGHT',    '전시회 출품작과 동일한 작품이 무단 업로드된 것으로 확인됩니다.',               'REVIEWING', null,                    '2025-08-01 10:00:00'),
    (113, 'MEMBER', 121, 'IMPERSONATION','공식 기관을 사칭하여 회원 개인정보를 수집하려는 정황이 있습니다.',              'REVIEWING', null,                    '2025-08-05 13:00:00'),
    (115, 'WORK',   102, 'SENSITIVE',    '작품에 포함된 이미지가 아동 보호 관련 가이드라인을 위반합니다.',               'REVIEWING', null,                    '2025-08-10 09:30:00'),
    (128, 'MEMBER', 104, 'HARASSMENT',   '낙찰 후 의도적으로 결제를 지연하며 판매자를 괴롭히고 있습니다.',               'REVIEWING', null,                    '2025-08-15 17:00:00'),
    -- RESOLVED 신고 (7건)
    (108, 'WORK',   119, 'COPYRIGHT',    '타 플랫폼에서 동일 작품이 다른 작가 명의로 확인되어 신고합니다.',              'RESOLVED',  '2025-05-20 14:00:00',   '2025-05-15 10:00:00'),
    (110, 'MEMBER', 107, 'HARASSMENT',   '댓글과 메시지를 통해 지속적으로 다른 작가를 비하하고 있습니다.',               'RESOLVED',  '2025-05-25 11:00:00',   '2025-05-20 09:00:00'),
    (100, 'WORK',   110, 'SENSITIVE',    '미성년자에게 유해한 콘텐츠가 별도 경고 없이 게시되어 있습니다.',               'RESOLVED',  '2025-06-05 16:00:00',   '2025-06-01 14:00:00'),
    (106, 'COMMENT', 5,  'HARASSMENT',   '작가에 대한 인신공격 및 협박성 댓글이 게시되어 있습니다.',                     'RESOLVED',  '2025-06-10 10:00:00',   '2025-06-07 08:00:00'),
    (117, 'WORK',   106, 'COPYRIGHT',    '원작자 허가 없이 상업 목적으로 사용된 정황을 포착했습니다.',                   'RESOLVED',  '2025-04-10 15:00:00',   '2025-04-05 11:00:00'),
    (120, 'MEMBER', 118, 'IMPERSONATION','유명 작가를 사칭하여 고가 작품을 허위 판매한 정황이 있습니다.',                'RESOLVED',  '2025-04-20 13:00:00',   '2025-04-15 09:00:00'),
    (122, 'WORK',   116, 'SENSITIVE',    '성인 등급 작품이 연령 제한 없이 공개되어 있습니다.',                           'RESOLVED',  '2025-03-15 11:00:00',   '2025-03-10 10:00:00'),
    -- CANCELLED 신고 (5건)
    (116, 'WORK',   101, 'COPYRIGHT',    '유사한 주제의 작품이지만 독립적으로 창작한 것으로 확인됨',                     'CANCELLED', '2025-05-05 14:00:00',   '2025-05-01 10:00:00'),
    (117, 'MEMBER', 100, 'HARASSMENT',   '오해로 인한 신고였습니다. 실제 harassment는 없었습니다.',                      'CANCELLED', '2025-05-10 11:00:00',   '2025-05-08 09:00:00'),
    (120, 'WORK',   103, 'SENSITIVE',    '검토 결과 가이드라인 위반 내용이 없어 취소 처리합니다.',                       'CANCELLED', '2025-03-25 15:00:00',   '2025-03-20 13:00:00'),
    (122, 'COMMENT', 7,  'HARASSMENT',   '신고 내용 확인 결과 허위 신고로 판명되었습니다.',                              'CANCELLED', '2025-04-25 10:00:00',   '2025-04-20 09:00:00'),
    (124, 'MEMBER', 125, 'IMPERSONATION','신고 내용 검토 후 동명이인으로 확인하여 취소 처리합니다.',                     'CANCELLED', '2025-06-20 16:00:00',   '2025-06-15 14:00:00');
...
-- 완료된 주문에 대한 결제 레코드
-- ==========================================================
insert into tbl_payment (payment_code, order_code, buyer_id, seller_id, work_id, auction_id, original_amount, total_price, total_fee, pay_method, status, paid_at)
values
    ('PAY-100', 'ORD-100', 103, 100, 100, 100, 1750000, 1750000, 175000, 'CARD',      'COMPLETED', '2025-09-03 10:35:00'),
    ('PAY-101', 'ORD-101', 105, 101, 101, 101, 1200000, 1200000, 120000, 'KAKAO_PAY', 'COMPLETED', '2025-09-12 14:38:00'),
    ('PAY-102', 'ORD-102', 110, 108, 108, 102, 2100000, 2100000, 210000, 'CARD',      'COMPLETED', '2025-10-04 09:42:00'),
    ('PAY-103', 'ORD-103', 117, 115, 115, 103, 1600000, 1600000, 160000, 'CARD',      'COMPLETED', '2025-10-22 11:40:00'),
    ('PAY-104', 'ORD-104', 124, 122, 122, 104, 880000,  880000,  88000,  'KAKAO_PAY', 'COMPLETED', '2025-11-07 13:45:00'),
    ('PAY-105', 'ORD-105', 101, 100, 102, null,480000,  480000,  48000,  'CARD',      'COMPLETED', '2025-10-15 10:05:00'),
    ('PAY-106', 'ORD-106', 103, 100, 106, null,550000,  550000,  55000,  'CARD',      'COMPLETED', '2025-10-20 14:08:00'),
    ('PAY-107', 'ORD-107', 106, 103, 103, null,300000,  300000,  30000,  'KAKAO_PAY', 'CANCELLED', '2025-11-10 09:05:00'),
    ('PAY-108', 'ORD-108', 108, 105, 105, null,1200000, 1200000, 120000, 'CARD',      'COMPLETED', '2025-11-15 13:12:00'),
    ('PAY-109', 'ORD-109', 110, 106, 106, null,550000,  550000,  55000,  'CARD',      'CANCELLED', '2025-11-20 16:05:00'),
    ('PAY-110', 'ORD-110', 113, 108, 108, null,280000,  280000,  28000,  'KAKAO_PAY', 'COMPLETED', '2025-12-01 10:06:00'),
    ('PAY-111', 'ORD-111', 115, 110, 109, null,420000,  420000,  42000,  'CARD',      'COMPLETED', '2025-12-05 14:10:00'),
    ('PAY-112', 'ORD-112', 116, 113, 111, null,880000,  880000,  88000,  'CARD',      'COMPLETED', '2025-12-10 09:08:00'),
    ('PAY-113', 'ORD-113', 117, 115, 112, null,450000,  450000,  45000,  'KAKAO_PAY', 'CANCELLED', '2025-12-15 11:05:00'),
    ('PAY-114', 'ORD-114', 120, 116, 113, null,260000,  260000,  26000,  'CARD',      'COMPLETED', '2026-01-05 10:05:00'),
    ('PAY-115', 'ORD-115', 122, 117, 116, null,320000,  320000,  32000,  'CARD',      'COMPLETED', '2026-01-10 14:07:00'),
    ('PAY-116', 'ORD-116', 124, 120, 117, null,530000,  530000,  53000,  'KAKAO_PAY', 'COMPLETED', '2026-01-15 09:09:00'),
    ('PAY-117', 'ORD-117', 125, 122, 119, null,280000,  280000,  28000,  'CARD',      'CANCELLED', '2026-02-01 10:05:00'),
    ('PAY-118', 'ORD-118', 128, 124, 121, null,470000,  470000,  47000,  'CARD',      'COMPLETED', '2026-02-10 14:11:00'),
    ('PAY-119', 'ORD-119', 100, 125, 123, null,620000,  620000,  62000,  'KAKAO_PAY', 'COMPLETED', '2026-02-15 09:08:00');
